    ...
    def check_d1(self, steps, opt_jastrow, opt_backflow):
        ...
        for cond, pos in zip(condition, position):
            if cond:
                ...
                self.logger.info(self.wfn.backflow.parameters_projector.T @ self.wfn.backflow.value_parameters_d1(e_vectors, n_vectors) / self.wfn.backflow.value_parameters_numerical_d1(e_vectors, n_vectors, False))
